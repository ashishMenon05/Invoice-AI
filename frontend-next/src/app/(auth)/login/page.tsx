...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate.push(email.includes("admin") ? "/admin/dashboard" : "/client/dashboard");
    } catch {
      ...
      <Card className="w-full max-w-md glass-card">
        <CardHeader className="text-center space-y-4">
          ...
          <div>
            ...
            <CardDescription>Sign in to InvoiceAI</CardDescription>
          </div>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="mt-4 rounded-lg bg-muted/50 p-3 text-xs text-muted-foreground space-y-1">
              <p><strong>Demo:</strong> Use "admin@invoiceai.com" for admin view</p>
              <p>Any other email logs in as client</p>
            </div>
          </form>
        </CardContent>
      </Card>
